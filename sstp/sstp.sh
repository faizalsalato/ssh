...
# Link Hosting Kalian
ssh_repo="raw.githubusercontent.com/faizalsalato/ssh/main/sstp"
...
wget -O /etc/accel-ppp.conf "https://${ssh_repo}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${ssh_repo}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${ssh_repo}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${ssh_repo}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${ssh_repo}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
