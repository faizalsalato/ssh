...
# Link Hosting Kalian
ssh_repo="raw.githubusercontent.com/faizalsalato/ssh/main/websocket"

# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://${ssh_repo}/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://${ssh_repo}/ws-ovpn.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://${ssh_repo}/ws-tls
