...
# ==================================================
# Link Hosting Kalian
ssh_repo="raw.githubusercontent.com/faizalsalato/ssh/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${ssh_repo}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${ssh_repo}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${ssh_repo}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${ssh_repo}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${ssh_repo}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${ssh_repo}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
