...
# Link Hosting Kalian
ssh_repo="raw.githubusercontent.com/faizalsalato/ssh/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${ssh_repo}/addss.sh"
wget -O delss "https://${ssh_repo}/delss.sh"
wget -O cekss "https://${ssh_repo}/cekss.sh"
wget -O renewss "https://${ssh_repo}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
