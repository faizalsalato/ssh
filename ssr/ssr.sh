...
# Link Hosting Kalian
ssh_repo="raw.githubusercontent.com/faizalsalato/ssh/main/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${ssh_repo}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${ssh_repo}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${ssh_repo}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${ssh_repo}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${ssh_repo}/renewssr.sh && chmod +x /usr/bin/renewssr
